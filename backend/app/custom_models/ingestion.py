...
# ``knowledge_chunks`` is shared across owners (Custom Models, Workspaces,
# and per-chat attachment RAG). Each chunk sets exactly one of these
# columns; the others stay NULL (CHECK constraint).
_SCOPE_COLUMN = {

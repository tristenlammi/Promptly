...
interface SSEPayload {
  ...
  message?: string;
  // memory_used event — which saved facts were injected this turn, shown
  // in the composer's memory popover. Memory *writes* are deliberately
  // silent: no chip, no tool card, nothing in scrollback.
  facts?: string[];
  ids?: string[];
  count?: number;

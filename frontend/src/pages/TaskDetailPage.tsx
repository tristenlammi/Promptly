...
import { tasksApi, type TaskRun } from "@/api/tasks";
 ...
 * run is clicked in the flow view. Lists what each node produced (n8n-style).
 */
...
export function TaskDetailPage() {
  ...
  // In the flow view, clicking a run opens a steps drawer (per-node outputs)
  // beside the canvas; the drawer can jump to the full classic report.
  const [flowRunOpen, setFlowRunOpen] = useState(false);
  const openRunSteps = (runId: string) => {
